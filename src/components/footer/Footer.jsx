    ...
    return (
        <div className="flex pb-[70px] justify-center mt-20 w-screen text-gray-600 md:flex-row flex-col md:gap-0 gap-4">
            <div className="flex-1 text-center flex flex-col items-center">
                ...
                <p className="md:w-[400px] md:text-xs text-[8px] md:my-2 my-1 w-[170px] md:pl-24"> Lorem ipsum doloripsum dolor amet dolor culpa hic sit quaerat nemo earum voluptates</p>
            ...
            <div className="flex flex-col gap-3 md:gap-12 flex-1 " >
